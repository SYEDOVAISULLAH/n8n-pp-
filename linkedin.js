...
// Example usage
const linkedinUrl = process.argv[2]; // LinkedIn profile URL from the command-line argument
const company = process.argv[3]; // Company name from the command-line argument
